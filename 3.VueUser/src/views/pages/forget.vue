	...
	<div>
		<div class="forget_view">
			<el-form :model="forgetForm" class="forget_box">
				<div class="forget_title">教务管理系统{{pageType==1?'找回密码':pageType==2?'输入密保':'重置密码'}}</div>
				<div class="tab_view">
...
<style lang="scss" scoped>
	.forget_view {
		...
		background: url(http://clfile.zggen.cn/20240308/069b39a2935a4e6490e2ca0869b25d8a.jpg);
		display: flex;
		min-height: 100vh;
