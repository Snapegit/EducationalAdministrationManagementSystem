	...
	<div class="app-contain" :style='{"padding":"20px 0px","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"20px","flexWrap":"wrap","background":"#fff","display":"flex","width":"64%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">教学态度</div>
					<div  class="info_text" >{{detail.jiaoxuetaidu}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">教学内容</div>
					<div  class="info_text" >{{detail.jiaoxueneirong}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">教学进度</div>
					<div  class="info_text" >{{detail.jiaoxuejindu}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">教学创新</div>
					<div  class="info_text" >{{detail.jiaoxuechuangxin}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">教学水平</div>
					<div  class="info_text" >{{detail.jiaoxueshuiping}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">评估时间</div>
					<div  class="info_text" >{{detail.pinggushijian}}</div>
				</div>
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('jiaoxuepinggu','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiaoxuepinggu','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiaoxuepinggu','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
