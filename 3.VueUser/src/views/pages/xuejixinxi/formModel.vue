		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					...
					<div  class="info_text" >{{detail.minzu}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">籍贯</div>
					<div  class="info_text" >{{detail.jiguan}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">入学时间</div>
					<div  class="info_text" >{{detail.ruxueshijian}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('xuejixinxi','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('xuejixinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('xuejixinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
