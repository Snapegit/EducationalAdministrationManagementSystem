			...
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="星期" prop="xingqi">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.xingqi?true:false"
							v-model="form.xingqi" 
							placeholder="请选择星期"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in xingqiLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
				...
				<el-col :span="12">
					<el-form-item label="第几节" prop="dijijie">
						<el-input class="list_inp" v-model="form.dijijie" placeholder="第几节"
							 type="text" 							:readonly="!isAdd||disabledForm.dijijie?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="12">
					<el-form-item label="人数" prop="renshu">
						<el-input class="list_inp" v-model.number="form.renshu" placeholder="人数"
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='xingqi'){
					form.value.xingqi = row[x];
					disabledForm.value.xingqi = true;
					continue;
				}
				if(x=='dijijie'){
					form.value.dijijie = row[x];
					disabledForm.value.dijijie = true;
					continue;
				}
				if(x=='banji'){
		...
		xingqiLists.value = "星期一,星期二,星期三,星期四,星期五".split(',')
		context?.$http({
