	...
	<div class="app-contain" :style='{"padding":"20px 0px","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"20px","flexWrap":"wrap","background":"#fff","display":"flex","width":"64%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">资料类型</div>
					<div  class="info_text" >{{detail.ziliaoleixing}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">资料简介</div>
					<div  class="info_text" >{{detail.ziliaojianjie}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">资料文件</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.ziliaowenjian" @click="downClick(detail.ziliaowenjian)">点击下载</el-button>
						<el-button class="info_undown" v-else>暂无</el-button>
					</div>
				</div>
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'下载')" @click="ziliaoxiazaionAcross('下载','ziliaoxiazai','','','')" type="warning">下载</el-button>
...
<script setup>
	...
	const ziliaoxiazaionAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
		if(!context?.$toolUtil.storageGet('frontToken')){
