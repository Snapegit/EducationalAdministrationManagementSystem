				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="民族" prop="minzu">
							<el-input class="list_inp" v-model="form.minzu" placeholder="民族"
								 type="text" 								:readonly="!isAdd||disabledForm.minzu?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="籍贯" prop="jiguan">
							<el-input class="list_inp" v-model="form.jiguan" placeholder="籍贯"
								 type="text" 								:readonly="!isAdd||disabledForm.jiguan?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="入学时间" prop="ruxueshijian">
							<el-date-picker
								class="list_date"
								v-model="form.ruxueshijian"
								format="YYYY 年 MM 月 DD 日"
								value-format="YYYY-MM-DD"
								type="datetime"
								:readonly="!isAdd||disabledForm.ruxueshijian?true:false"
								placeholder="请选择入学时间" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='minzu'){
					form.value.minzu = row[x];
					disabledForm.value.minzu = true;
					continue;
				}
				if(x=='jiguan'){
					form.value.jiguan = row[x];
					disabledForm.value.jiguan = true;
					continue;
				}
				if(x=='jiatingzhuzhi'){
				...
				if(x=='ruxueshijian'){
					form.value.ruxueshijian = row[x];
					disabledForm.value.ruxueshijian = true;
					continue;
				}
				if(x=='beizhu'){
